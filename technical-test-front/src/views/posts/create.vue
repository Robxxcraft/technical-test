    ...
    <div class="w-full bg-slate-100">
        ...
        <div class="py-6 lg:py-8 px-4 md:px-8 lg:px-12 flex justify-center">
            <div class="bg-white w-full max-w-2xl rounded-lg shadow-sm py-5">
                <div class="text-xl text-purple-600 text-center font-bold mb-2">Create new post</div>
                <form class="w-full mx-auto md:px-8 py-4" @submit.prevent="savePost">
                    <div class="flex max-w-lg mx-auto flex-wrap px-0 md:px-8 flex-col">
                        <div class="relative pb-5 flex-2">
                            ...
                            <input class="focus:outline-offset-2 outline-purple-400 mt-2 w-full bg-gray-50 text-gray-700 border border-gray-300 rounded-lg py-3 px-4 mb-3" v-model="form.title" placeholder="Enter title" type="text">
                        ...
                        <div class="relative pb-5 flex-2">
                            ...
                            <input class="focus:outline-offset-2 outline-purple-400 mt-2 w-full bg-gray-50 text-gray-700 border border-gray-300 rounded-lg py-3 px-4 mb-3" v-model="form.category" placeholder="Enter category" type="text">
                        ...
                        <div class="relative pb-5 flex-2">
                            ...
                            <textarea class="focus:outline-offset-2 outline-purple-400 mt-2 w-full bg-gray-50 text-gray-700 border border-gray-300 rounded-lg py-3 px-4 mb-3" v-model="form.content" placeholder="Enter content"></textarea>
                        ...
                        <div class="relative pb-5 flex-2">
                            ...
                            <input class="focus:outline-offset-2 outline-purple-400 mt-2 w-full bg-gray-50 text-gray-700 border border-gray-300 rounded-lg py-3 px-4 mb-3" v-model="form.author" placeholder="Enter author" type="text">
...
export default {
    ...
    setup() {
        ...
        const savePost = () => {
            loading.value = true
            api.post('/api/posts/create', form).then(res=>{
                loading.value = false
        ...
        return { loading, toast, toastContent, savePost, errors, form }
    }
};
</script>